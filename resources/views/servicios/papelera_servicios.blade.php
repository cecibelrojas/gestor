...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{!! trans('messages.servicio_deshabilitado') !!}</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?php echo url('/servicios'); ?>">{!! trans('messages.servicioconsular') !!}</a></li>
                    <li class="breadcrumb-item active">{!! trans('messages.servicio_deshabilitado') !!}</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card card-solid">
                    <div class="card-header">
                        <h3 class="card-title">Lista de Servicios Consulares Deshabilitados</h3>
                    </div>
...
<script>
        ...
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?php echo url('restaurar-servicio') ?>',
                    type: 'POST',
                    data: {
                        id: id
                    },
    ...
    function eliminar(id = null) {
        ...
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?php echo url('/eliminarservicio') ?>',
                    type: 'POST',
                    data: {
                        id: id
                    },
