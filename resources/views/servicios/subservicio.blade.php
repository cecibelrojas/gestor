              ...
              <div class="card bg-light d-flex flex-fill">
                ...
                <div class="card-footer">
                  <div class="text-right">
                    <a href="{{ url('detalle_subservicio', ['id' => $key->id]) }}" class="btn btn-sm btn-info"><i class="fas fa-file-alt"></i> {!! trans('messages.detalle') !!}</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{!! trans('messages.sub_servicios_consulares') !!}</h4>
...
<script>
    ...
    function formulario(id = null) {
        $.ajax({
            url: '<?php echo url('/formulario_subservicios') ?>',
            type: 'POST',
            data: {
                id: id,
    ...
    function eliminar(id = null) {
        ...
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?php echo url('/eliminar_subservicio') ?>',
                    type: 'POST',
                    data: {
                        id: id
                    },
