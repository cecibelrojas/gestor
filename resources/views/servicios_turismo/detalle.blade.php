    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>
             Detalles del Servicio Turismo de :
            </h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{url('/servicios_turismo')}}">{!! trans('messages.servicio_turismo') !!}</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="col-12 col-sm-6 col-md-12 d-flex align-items-stretch flex-column">
              <div class="card bg-light d-flex flex-fill">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-12">
                      <img src="<?php echo env('APP_ADMIN') . "" . $key['imagen_principal']; ?>" onerror="this.src='<?php echo asset('archivos/turismo_nacional/img.png'); ?>'" class="imgpreview" width="100%">
                    </div>
                  </div>
            ...
            <div class="col-12 col-sm-6 col-md-12 d-flex align-items-stretch flex-column">
              <div class="card bg-light d-flex flex-fill">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-12">
                      <img src="{{asset('archivos/turismo_nacional/img.png')}}" class="imgpreview" width="100%">
                    </div>
                  </div>
                </div>
              </div>
...
<script>
      var turismo_id = '<?php echo $turismo_id; ?>';
    ...
    function formulario(id = null) {
        $.ajax({
            url: '<?php echo url('/formulario_detalle_turismo') ?>',
            type: 'POST',
            data: {
                id: id,
                turismo_id: turismo_id
            },
            beforeSend: function() {
