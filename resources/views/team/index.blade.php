...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Pelota Caribe</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?php echo url('/'); ?>">Inicio</a></li>
                    <li class="breadcrumb-item active">Pelota Caribe</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="card card-info">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <button class="btn btn-sm btn-light" id="btnNuevo"><i class="fa fa-plus-circle"></i>  Nuevo Equipo</button>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                <?php if (count($lista) > 0) : ?>
                                    <?php foreach ($lista as $key) : ?>
                                        <tr>
                                            <td><img style="object-fit: contain;width: 32px;height: 32px;" src="<?php echo url('/') . $key['logo']; ?>"></td>
                                            <td><?php echo $key['nombre']; ?></td>
                                            <td><?php echo $key['ciudad']; ?></td>
                                            <td><?php echo $key['sede']; ?></td>
                                            <td><?php echo $key['entidaddes']; ?></td>
...
<script>
    ...
    function eliminar(id = null) {
        ...
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?php echo url('/eliminar-equipo') ?>',
                    type: 'POST',
                    data: {
                        id: id
                    },
