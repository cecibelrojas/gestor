...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Tabla de Posiciones Temporada Regular</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?php echo url('/'); ?>">Inicio</a></li>
                    <li class="breadcrumb-item active">Tabla de Posiciones Temporada Regular</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                                ...
                                <?php if (count($lista) > 0) : ?>
                                    <?php foreach ($lista as $key) : ?>
                                        <tr>
                                            ...
                                            <td>
                                            <select class="form-control select2" required onchange="updatescore(this,<?php echo $key['id']; ?>,'estado')">>
                                                <option value="" <?php if ('' == $key['estado']) { ?> selected <?php } ?>>Seleccione</option>
                                                 <option value="C" <?php if ('C' == $key['estado']) { ?> selected <?php } ?>>Clasificado</option>
                                                 <option value="E" <?php if ('E' == $key['estado']) { ?> selected <?php } ?>>Eliminado</option> 
                                            </select>
                                            </td>
