<div class="row" style="margin-left: 0px;">
    <?php if (count($data) > 0) : ?>
        <?php foreach ($data as $index => $key) : ?>
            <a style="display: none;" class="example-image-link<?php echo $index; ?>" href="<?php echo asset('/archivos/imagenes_medios/' . $key['archivo']); ?>" data-lightbox="example-set" data-title="">
                <div class="example-image" style="background-image: url('<?php echo asset('/archivos/imagenes_medios/'. $key['archivo']); ?>');height: 130px;background-size: cover;background-repeat: no-repeat;background-position: center center; border: 1px solid #ffffff;border-radius: 2px;"></div>
            </a>
