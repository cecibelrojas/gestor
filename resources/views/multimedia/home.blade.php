                  ...
                  <div class="mb-2">
                    <div class="float-left" style="margin-right: 20px">
                      <select class="custom-select" style="width: auto;" data-sortorder="">
                        ...
                        <option value="sortData">Audio</option>
                ...
                <?php foreach ($lista as $key) : ?>                         
                    <div class="filtr-item col-md-2" data-category="1" data-sort="<?php echo $key['titulo']; ?>" style="border: 1px solid #cdcdcd;padding: 8px;">
                      <a href="#" onclick="formulario(<?php echo $key['id']; ?>)" data-toggle="lightbox" data-title="<?php echo $key['titulo']; ?>">
                        ...
                        <?php endif;  ?>
                        <?php if ($key['tipo'] == 'F') :  ?>
                           <center><img src="{{asset('assets/images/small/pdfs.png')}}" class="img-fluid mb-2" style="height: 100px;width: 50%;object-fit: cover;" alt="<?php echo $key['titulo']; ?>" /></center>
                            <div style="border-top: 1px solid #cdcdcd"><span class="m-auto"><?php echo $key['titulo']; ?></span></div>
                         <?php endif;  ?>                            
                      </a>
                    </div>
                <?php endforeach; ?>
