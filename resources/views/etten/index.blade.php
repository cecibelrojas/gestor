            ...
            <div class="col-lg-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Lista de Mancheta Etten</h3>
                        <div class="card-tools">
                            <button class="btn btn-sm btn-light" id="btnNuevo"><i class="fa fa-plus-circle"></i> Nueva Imagen Etten</button>
                        </div>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Mancheta Etten</h4>
...
<script>
    ...
    function formulario(id = null) {
        $.ajax({
            url: '<?php echo url('/mancheta_etten') ?>',
            type: 'POST',
            data: {
                id: id
            },
    ...
    function eliminar(id = null) {
        ...
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?php echo url('/eliminar-etten') ?>',
                    type: 'POST',
                    data: {
                        id: id
                    },
