...
<script>
    var dataSet = <?php echo json_encode($widgets); ?>;
    ...
    function eliminar() {
        ...
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?php echo url('/eliminar-widget') ?>',
                    type: 'POST',
                    data: {
                        id: data.id
                    },
    ...
    function eliminar2() {
        ...
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?php echo url('/eliminar-widget-publicacion') ?>',
                    type: 'POST',
                    data: {
                        id: data.id,
                        item: data.item
    ...
    function obtener_detalle(det) {
        ...
        $.ajax({
            url: '<?php echo url('/widgets-detalles') ?>',
            type: 'POST',
            data: {
                id: det
            },
    ...
    function formulario(id = null) {
        $.ajax({
            url: '<?php echo url('/widgets-cabecera') ?>',
            type: 'POST',
            data: {
                id: id
            },
    ...
    function filtrar() {
        $.ajax({
            url: '<?php echo url('/widgets-cabeceras') ?>',
            type: 'POST',
            beforeSend: function() {
    ...
    function formulario2(item = null, accion = 'I') {
        ...
        if (typeof data === 'undefined') {
            swal({
                type: "info",
                title: "¡Debe seleccionar un widget!",
                showConfirmButton: true
            });
            return false;
        }
        ...
        $.ajax({
            url: '<?php echo url('/widgets-detalle') ?>',
            type: 'POST',
            data: {
                id: data.id,
                item: item,
