...
<div class="row">
    ...
    <div class="col-lg-12">
        <label style="font-size: 12px;font-weight: bold;">Título del Aviso <span style="color: red;">*</span></label>
        <input type="text" class="form-control input-sm" value="<?php echo $data ? $data['titulo'] : ''; ?>"  id="titulo" style="border: 1px solid #b9b9b9;">
    </div>
    <div class="col-lg-12">
        <label style="font-size: 12px;font-weight: bold;">Solicitante<span style="color: red;">*</span></label>
        <input type="text" class="form-control input-sm" value="<?php echo $data ? $data['solicitante'] : ''; ?>"  id="solicitante" style="border: 1px solid #b9b9b9;">
    </div>
    <div class="col-lg-12">
        <label style="font-size: 12px;font-weight: bold;">Departamento<span style="color: red;">*</span></label>
        <input type="text" class="form-control input-sm" value="<?php echo $data ? $data['departamento'] : ''; ?>"  id="departamento" style="border: 1px solid #b9b9b9;">
    </div>
    <div class="col-lg-12">
    ...
    <div class="col-lg-6">
        <label style="font-size: 12px;font-weight: bold;">Tipo de Aviso <span style="color: red;">*</span></label>
        <select class="form-control form-select" aria-label="tipo" id="tipo">
            <option value="">Seleccione</option>
            <option value="A" <?php if ($data && 'A' == $data['tipo']) { ?> selected <?php } ?>>Notificación</option>
        </select>
    </div>
    <div class="col-lg-6">
