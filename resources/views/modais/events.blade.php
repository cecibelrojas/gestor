    ...
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="titleModal">Crear Evento</h5>
            ...
            <div class="modal-body">
                ...
                <form id="formEvent">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <label for="start" style="font-size: 12px;font-weight: bold;">Fecha y Hora Inicial</label>
                            <input type="text" name="start" class="form-control date-time" id="start">
                        </div>
                        <div class="col-lg-12">
                            <label for="end" style="font-size: 12px;font-weight: bold;">Fecha y Hora Final</label>
                        ...
                        <div class="form-group">
                            <label  for="description" style="font-size: 12px;font-weight: bold;">Descripción</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger deleteEvent">Eliminar</button>
