...
<div class="row">
    ...
    <img onclick="$('#img_video').trigger('click');" src="<?php echo ($data && !empty($data['img_video'])) ? url('/') . $data['img_video'] : asset('archivos/campana_otros/img.jpg'); ?>" style="object-fit: cover;box-shadow: 1px 1px 8px 0px #7e7e7e;cursor: pointer;width: 220px;height: 320px;" class="imgpreview">
