        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Medios</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="col-lg-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Lista de Medios</h3>
                                ...
                                <?php if (count($lista) > 0) : ?>
                                    <?php foreach ($lista as $key) : ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><?php if ($key['tipo'] == 'I') {
                                                                                $carpeta = 'imagenes';
                                                                                echo "Imagen";
                                                                            } elseif ($key['tipo'] == 'V') {
                                                                                $carpeta = 'videos';
                                                                            ...
                                                                            ?></td>
                                            <td><a href="<?php echo url('') . "/archivos/" . $carpeta . "/" . $key['producto_id'] . "/" . $key['archivo']; ?>" target="_blank">Ver medio</a></td>
                                            <!--td>
