...
<div class="row">
    <div class="col-lg-4">
        <label style="font-size: 12px;font-weight: bold;">Código</label>
        <input type="text" class="form-control input-sm" value="<?php echo $data ? $data['codigo'] : ''; ?>" maxlength="50" id="codigo" style="border: 1px solid #b9b9b9;">
    </div>
    <div class="col-lg-8">
...
<script>
    $('#btnSave').click(function() {
        ...
        $.ajax({
            url: '<?php echo url('/guardar-etiqueta') ?>',
            type: 'POST',
            data: {
                id: $('#id').val(),
                codigo: $('#codigo').val(),
