...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">El Especulador Precoz</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <table class="table table-responsive-lg" id="maintable">
                            ...
                            <tbody>
                                <?php if (count($listar_especulador) > 0) : ?>
                                    <?php foreach ($listar_especulador as $key) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-success" onclick="formulario_especulador(<?php echo $key['id']; ?>)"><i class="fas fa-search"></i></button>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else : ?>
...
<script type="text/javascript">
    ...
    function formulario_especulador(id = null) {
        $.ajax({
            url: '<?php echo url('/impreso_especulador') ?>',
            type: 'POST',
            data: {
                id: id
            },
