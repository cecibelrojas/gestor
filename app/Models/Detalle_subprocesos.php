...
class Detalle_subprocesos extends Model
{
    protected $table = 'detalle_subprocesos';

    protected $fillable = ['id','subservicio_id','titulo_principal','titulo_principal_ingles','icono','usureg','created_at','usumod','updated_at','estado'];
    ...
    public function listar(array $params = array())
    {
        ...
        $select = $this->from('detalle_subprocesos as d')
    ...
    {
        try {
            $delete = DB::table('detalle_subprocesos')->where('id', $params['id'])->delete();
            return $delete;
        } catch (\Exception $e) {
            return $e->getMessage();
        }
