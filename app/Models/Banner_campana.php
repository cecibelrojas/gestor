...
class Banner_campana extends Model
{
    protected $table = 'banner_campana';

    protected $fillable = ['id', 'imagen_banner','url', 'estado','usureg', 'usumod', 'created_at', 'updated_at'];
    ...
    public function listar(array $params = array())
    {
        ...
        $select = $this->from('banner_campana as c')
    ...
    {
        try {
            $delete = DB::table('banner_campana')->where('id', $params['id'])->delete();
            return $delete;
        } catch (\Exception $e) {
            return $e->getMessage();
        }
