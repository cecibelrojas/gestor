...
class Detalle_apostilla extends Model
{
    ...
    protected $fillable = ['id','subservicio_id','titulo1','titulo2','titulo1_ingles','titulo2_ingles','descripcion1','descripcion2','descripcion1_ingles','descripcion2_ingles','titulo_infografia','titulo_infografia_ingles','infografia','link','parallax','','titulo_parallax','titulo_parallax_ingles','des_parallax','des_parallax_ingles','usureg','usumod','created_at','updated_at'];
