...
class Posiciones_rr extends Model
{
    protected $table = 'posiciones_rr';
    ...
    public function listar(array $params = array())
    {
        ...
        $select = $this->from('posiciones_rr as p')
            ->select('p.*')
    ...
    {
        try {
            $delete = DB::table('posiciones_rr')->where('id', $params['id'])->delete();
            return $delete;
        } catch (\Exception $e) {
            return $e->getMessage();
        }
